...
<7> Whitebox security analysis for external pentesters: architecture, attack
    surface, critical paths, cryptographic review, smart contract security, and
    threat model. See link:security/[`security/`].
