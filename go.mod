...
replace (
	github.com/bnb-chain/tss-lib => github.com/threshold-network/tss-lib v0.0.0-20260729021955-d847ce003019
	...
	github.com/keep-network/keep-common => github.com/threshold-network/keep-common v1.7.1-tlabs.1
)
